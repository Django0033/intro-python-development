...
print('The average life expectancy across all countries was {:.2f}'.format(average_life_interest))
print('The max life expectancy was in {} with {}'.format(max_country_interest, max_life_interest))
print('The min life expectancy was in {} with {}'.format(min_country_interest, min_life_interest))
...
average_life_interest = sum(life_of_interest) / len(life_of_interest)
max_life_interest = max(life_of_interest)
max_year_interest = years_of_interest[life_of_interest.index(max_life_interest)]
min_life_interest = min(life_of_interest)
min_year_interest = years_of_interest[life_of_interest.index(min_life_interest)]

print('\nFor {}:'.format(country_of_interest.capitalize()))
print('The average life expectancy is {:.2f}'.format(average_life_interest))
print('The max life expectancy was in {} with {}'.format(max_year_interest, max_life_interest))
print('The min life expectancy was in {} with {}'.format(min_year_interest, min_life_interest))
